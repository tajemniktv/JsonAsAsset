...
#if UE4_18_BELOW
	UPackage* AnimPackage = CreatePackage(nullptr, *AnimSequencePackagePath);
#else
...
#if UE4_18_BELOW
			auto& Track = TrackMap[BoneName];
			auto& PosKeys = Track.PosKeys;
			auto& RotKeys = Track.RotKeys;
			auto& ScaleKeys = Track.ScaleKeys;
#else
